...
git clone https://github.com/LineageOS/android_hardware_qcom_bt -b lineage-15.1-caf hardware/qcom/bt-caf
rm -rf system/bt
git clone https://github.com/LineageOS/android_system_bt -b lineage-15.1 system/bt
